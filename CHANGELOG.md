...
- Raise dependency lower bounds to tested versions: RestrictedBoltzmannMachines 5, FillArrays 1.9, Optimisers 0.4.
- Remove unused explicit imports and the unused internal helper `batchcat` (no behavior change).
